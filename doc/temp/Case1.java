...
public class Case1 extends TestCase {
    ...
    final int                 LOOP_COUNT       = 1000000 * 1 * 1 / threadCount;
...
//
    ...
    public void test5() throws Exception {
        ...
        for (int i = 0; i < loopCount; ++i) {
            p0(datasource, "HikariCP",threadCount);
        }
        System.out.println();
    }
    ...
    public void test6() throws Exception {
        ...
        for (int i = 0; i < loopCount; ++i) {
            p0(dataSource, "BeeCP_Compete",threadCount);
        }
        System.out.println();
    }
    ...
    public void test7() throws Exception {
        ...
        for (int i = 0; i < loopCount; ++i) {
            p0(dataSource, "BeeCP_Fair",threadCount);
        }
        System.out.println();
    }
