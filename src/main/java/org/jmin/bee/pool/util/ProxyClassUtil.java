...
import org.jmin.bee.pool.ProxyConnectionBase;
import org.jmin.bee.pool.ProxyConnectionFactory;
import org.jmin.bee.pool.ProxyDatabaseMetaDataBase;
...
public final class ProxyClassUtil {
   ...
   *  
   * new Class:
   * org.jmin.bee.pool.ProxyConnection
   ...
   */
	public CtClass[] createJdbcProxyClasses() throws Exception {
		try{
			...
			String ctConIntfProxyClassName ="org.jmin.bee.pool.ProxyConnection";
			...
			String cttDatabaseMetaDataIntfProxyClassName ="org.jmin.bee.pool.ProxyDatabaseMetaData";
