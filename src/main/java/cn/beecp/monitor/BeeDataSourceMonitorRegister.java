 ...
 * @author Chris.Liao
 */
public class BeeDataSourceMonitorRegister implements ImportBeanDefinitionRegistrar {
    ...
    public final void registerBeanDefinitions(AnnotationMetadata importingClassMetadata,
        ...
        if (!existsBeanDefinition(registerName, registry)) {
            ...
            define.setBeanClass(BeeDataSourceMonitor.class);
            define.setPrimary(true);
            define.setInstanceSupplier(new Supplier() {
                public Object get() {
                    return new BeeDataSourceMonitor();
                }
            });
