...
public class TestUtil {
    ...
    public static Object invokeMethod(Object ob, String methodName) {
        Method method;
        try {
            method = ob.getClass().getDeclaredMethod(methodName);
        } catch (NoSuchMethodException e) {
            try {
                method = ob.getClass().getMethod(methodName);
    ...
    public static void setFieldValue(Object ob, String fieldName, Object value) throws Exception {
        Field field = getField(ob.getClass(), fieldName);
    ...
    private static Method getMethod(final Class clazz, final String methodName) throws Exception {
        Method method = null;
        try {
        ...
        Class parentClass = clazz.getSuperclass();
        if (parentClass != Object.class) {
            return getMethod(parentClass, methodName);
        } else {
