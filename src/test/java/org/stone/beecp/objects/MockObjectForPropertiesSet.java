 ...
 * @author Chris Liao
 */
public class MockObjectForPropertiesSet {
    private Number nullTxt;
    private String string;
    private Long workLongTime;
    ...
    public Long getWorkLongTime() {
        return workLongTime;
    }

    public void setWorkLongTime(Long workLongTime) {
