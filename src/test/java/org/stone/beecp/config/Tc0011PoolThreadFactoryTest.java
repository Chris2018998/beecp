...
import org.stone.beecp.objects.SampleThreadFactory;

/**
 * @author Chris Liao
 */
public class Tc0011PoolThreadFactoryTest extends TestCase {
    ...
    public void testOnSetGet() {
        ...
        Class<? extends SampleThreadFactory> factClass = SampleThreadFactory.class;
    ...
    public void testOnCreation() throws Exception {
        ...
        config1.setThreadFactory(new SampleThreadFactory());
        ...
        config2.setThreadFactoryClass(SampleThreadFactory.class);
        checkConfig = config2.check();
        Assert.assertNotNull(checkConfig.getThreadFactory());

        BeeDataSourceConfig config3 = DsConfigFactory.createDefault();
        config3.setThreadFactoryClassName("org.stone.beecp.objects.SampleThreadFactory");
