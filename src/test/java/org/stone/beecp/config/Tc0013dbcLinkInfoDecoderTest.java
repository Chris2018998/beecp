...
import org.stone.beecp.objects.NullConnectionFactory;
import org.stone.beecp.objects.SampleJdbcLinkInfoDecoder;
...
public class Tc0013dbcLinkInfoDecoderTest extends TestCase {
    ...
    public void testOnSetGet() {
        ...
        Class<? extends BeeJdbcLinkInfoDecoder> decodeClass = SampleJdbcLinkInfoDecoder.class;
        ...
        SampleJdbcLinkInfoDecoder decoder = new SampleJdbcLinkInfoDecoder();
    ...
    public void testOnCreation() throws Exception {
        ...
        config1.setJdbcLinkInfoDecoder(new SampleJdbcLinkInfoDecoder());
        ...
        config3.setJdbcLinkInfoDecoderClassName("org.stone.beecp.objects.SampleJdbcLinkInfoDecoder");
    ...
    public void testJdbcDecoderOnDriver() throws Exception {
        ...
        config1.setJdbcLinkInfoDecoderClass(SampleJdbcLinkInfoDecoder.class);
        ...
        BeeDataSourceConfig config2 = new BeeDataSourceConfig(driver, url, username, password);
        config2.setJdbcLinkInfoDecoderClass(SampleJdbcLinkInfoDecoder.class);
        ...
        config3.setJdbcLinkInfoDecoderClass(SampleJdbcLinkInfoDecoder.class);
    ...
    public void testJdbcDecoderOnFactory() throws Exception {
        ...
        config4.setJdbcLinkInfoDecoderClass(SampleJdbcLinkInfoDecoder.class);
        ...
        config5.setJdbcLinkInfoDecoderClass(SampleJdbcLinkInfoDecoder.class);
