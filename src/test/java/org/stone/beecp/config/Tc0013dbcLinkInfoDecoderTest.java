...
import static org.stone.beecp.config.DsConfigFactory.clearBeeCPInfoFromSystemProperties;
...
public class Tc0013dbcLinkInfoDecoderTest extends TestCase {
    ...
    public void testOnSetGet() {
        ...
        Class<? extends BeeJdbcLinkInfoDecoder> decodeClass = DummyJdbcLinkInfoDecoder.class;
