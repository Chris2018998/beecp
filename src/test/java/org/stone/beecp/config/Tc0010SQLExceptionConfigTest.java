...
import org.stone.beecp.objects.SampleSqlExceptionPredication;
...
public class Tc0010SQLExceptionConfigTest extends TestCase {
    ...
    public void testOnPredicationSettingAndGetting() {
        ...
        BeeConnectionPredicate predication = new SampleSqlExceptionPredication();
        config.setEvictPredicate(predication);
        Assert.assertEquals(config.getEvictPredicate(), predication);

        Class<? extends BeeConnectionPredicate> predicationClass = SampleSqlExceptionPredication.class;
    ...
    public void testOnPredicationCreation() throws Exception {
        ...
        String predicationClassName = "org.stone.beecp.objects.SampleSqlExceptionPredication";
