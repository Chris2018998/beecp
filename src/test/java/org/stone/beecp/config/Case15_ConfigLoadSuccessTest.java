 ...
 * @version 1.0
 */
public class Case15_ConfigLoadSuccessTest extends TestCase {
    ...
    public void testConstructWithFile() throws Exception {
        URL url = Case15_ConfigLoadSuccessTest.class.getClassLoader().getResource(filename);
        if (url == null) url = Case15_ConfigLoadSuccessTest.class.getResource(filename);
    ...
    public void testConstructWithProperties() throws Exception {
        Class selfClass = Case15_ConfigLoadSuccessTest.class;
