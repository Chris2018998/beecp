...
public class Tc0031DataSourcePoolTest extends TestCase {
    ...
    public void testPoolInitializeFailedException() {
        ...
        try {
            ...
            Assert.assertTrue(bottomException.getMessage().contains("The configured value of item 'initial-size' cannot be greater than the configured value of item 'max-active'"));
        } finally {
            if (ds != null) ds.close();
        }
    }
