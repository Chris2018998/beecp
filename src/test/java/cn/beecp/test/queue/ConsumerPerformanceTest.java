...
public class ConsumerPerformanceTest {
    public static void main(String[] args) throws Exception {
        ...
        testTransferQueue("ConcurrentTransferQueue",new ConcurrentTransferQueue<Object>(), producerSize, consumerSize, takeTimes);
    }
    ...
    private static void testTransferQueue(String queueName, Queue<Object> queue, int producerSize, int consumerSize, int pollSize) throws Exception {
        ...
        Method pollMethod=queue.getClass().getMethod("poll",new Class[]{Long.TYPE,TimeUnit.class});
    ...
    private static final Object poll(Queue<Object>queue,Method pollMethod){
        try {
            return  pollMethod.invoke(queue, new Object[]{Integer.MAX_VALUE, TimeUnit.NANOSECONDS});
        }catch(Throwable e){
            e.printStackTrace();
            return null;
        }
